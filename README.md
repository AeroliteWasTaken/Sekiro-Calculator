...
## Displayed Data:
 ...
 - Average hits to kill - A very loose estimate of how many attacks it would take to deplete the enemy's health, just to help you get an idea of their HP. This feature can help you get a pretty accurate ratio to compare different enemies, but shouldn't be used as an actual gauge for fight length as resistances and many combat variables such as blocked attacks are not taken into account.
